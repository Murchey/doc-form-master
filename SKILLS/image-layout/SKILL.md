...
name: image-layout
description: |
  专业 DOCX 图片布局优化 Skill。

  用于检测、分析、保护和优化 DOCX 文档中的图片布局，
  保持图文关系稳定，
  防止图片跨页、错位、覆盖正文等问题。
...
```text
optimized/image_layout_ast.json
reports/image_layout_report.json
logs/image_layout.log
```
